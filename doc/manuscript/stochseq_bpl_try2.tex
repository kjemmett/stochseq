...
Lu et al. report an experimental bias term of $Fa/4k_{B}T=0.2$ ($\bias=0.69$), for which show single-pass accurate sequence recovery is impossible \cite{Lu:2011}.
