...
\begin{figure}\vspace*{3pt}
  \centering{\includegraphics[width=3.25in]{fig/fig1-alternative-withcartoon.eps}}
...
\begin{figure}
  \centering{\includegraphics[width=3.25in]{fig/fig-output.eps}}
...
% What I'm going to do is merely note that there appears to be a correlation betwen
% inference entropy and errors, and that this could possibly be used for error correction.
