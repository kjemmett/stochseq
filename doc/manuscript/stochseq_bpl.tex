...
Current generation sequencing platforms have led to an explosion in available sequence data, rapidly advancing our understanding of the genomic underpinnings of life.
...
However, the shortness of the raw data makes some information, particularly phasing and haplotype structure, unavailable even at the highest levels of coverage.
...
\caption{(A) Idealized example of a nanopore sequencing device. (B) Transit time distribution for different forward biases. (C) }
\label{fig:fig1}
\end{figure}
...
\begin{figure}
  \centering{\includegraphics[width=3.25in]{fig/fig4.pdf}}
